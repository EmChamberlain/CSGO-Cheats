...
const DWORD playerBase = 0xAABFFC;
const DWORD entityBase = 0x4A88534;
const DWORD viewMat1Offset = 0x04A79FA4;
const DWORD enginePositionOffset = 0x59F21C;//also called dwClientState or EnginePointer; 0x006BD9BC
