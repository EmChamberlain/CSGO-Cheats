...
const DWORD playerBase = 0x6F8490;
const DWORD entityBase = 0x712534;
const DWORD viewMat1Offset = 0x6FCBBC;
const DWORD enginePositionOffset = 0x44EC48;//also called dwClientState or EnginePointer; 0x006BD9BC
...
const DWORD xyzOffset = 0x00000120;//m_vecOrigin
const DWORD teamOffset = 0xdc;
const DWORD healthOffset = 0xe8;
const DWORD isDeadOffest = 0x247;
...
const DWORD velocityOffset = 0xfc;
const DWORD shotsFiredOffset = 0x0000A2C0;
const DWORD punchAngOffset = 0x6c;//0x00004C28
const DWORD vecViewOffset = 0xf0;
...
DWORD WINAPI Main(LPVOID Params) {
	...
	while (!csWindow)
	{
		csWindow = FindWindow(0, L"INSURGENCY");
		Sleep(1000);
	}
	process = NULL;
	while (!process)
