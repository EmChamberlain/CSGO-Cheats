...
void CDraw::Text(const char *text, float x, float y, int orientation, int font, bool bordered, DWORD color, DWORD bcolor)
{
	RECT rect;
	...
	case lefted:
		if (bordered)
		{
			SetRect(&rect, (int)(x - 1), (int)(y), (int)(x - 1), (int)(y));
			pFont[font]->DrawTextA(NULL, text, -1, &rect, DT_LEFT | DT_NOCLIP, bcolor);
			SetRect(&rect, (int)(x + 1), (int)(y), (int)(x + 1), (int)(y));
			pFont[font]->DrawTextA(NULL, text, -1, &rect, DT_LEFT | DT_NOCLIP, bcolor);
			SetRect(&rect, (int)(x), (int)(y - 1), (int)(x), (int)(y - 1));
			pFont[font]->DrawTextA(NULL, text, -1, &rect, DT_LEFT | DT_NOCLIP, bcolor);
			SetRect(&rect, (int)(x), (int)(y + 1), (int)(x), (int)(y + 1));
			pFont[font]->DrawTextA(NULL, text, -1, &rect, DT_LEFT | DT_NOCLIP, bcolor);
		}
		SetRect(&rect, (int)(x), (int)(y), (int)(x), (int)(y));
...
void CDraw::AddFont(wchar_t* Caption, float size, bool bold, bool italic)
{
