...
const DWORD playerBase = 0x6B6770;
const DWORD entityBase = 0x6CFA84;
const DWORD viewMat1Offset = 0x6BACF4;
const DWORD enginePositionOffset = 0x450BF0;//also called dwClientState
...
const DWORD crosshairOffset = 0x2424;
